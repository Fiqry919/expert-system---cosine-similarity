...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">Edit Penyakit</div>
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($penyakit, array('url' => "penyakit/$penyakit->id", 'method' => 'put')) !!}
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group first">
                                    {!! Form::label('kode', 'Kode', ['class' => 'control-label required']) !!}
                                    {!! Form::text('kode', null, ['autocomplete' => 'off', 'class' => 'form-control', 'placeholder' => 'Masukan kode penyakit', 'readonly']) !!}
