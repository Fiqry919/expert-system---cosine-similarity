        ...
        <div class="col-md-10">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::model($gejala, array('url' => "gejala/$gejala->id", 'method' => 'put')) !!}
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group first">
                                {!! Form::label('kode', 'Kode', ['class' => 'control-label required']) !!}
                                {!! Form::text('kode', null, ['autocomplete' => 'off', 'class' => 'form-control', 'placeholder' => 'Masukan kode gejala', 'readonly']) !!}
