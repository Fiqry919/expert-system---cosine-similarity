        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'aturan.store']) !!}
                    <div class="row">
                        <div class="col-md-0">
                            <div class="form-group first">
                                {{-- {!! Form::label('kode', 'Kode', ['class' => 'control-label required']) !!} --}}
                                {!! Form::hidden('kode', $kodeRules, ['autocomplete' => 'off', 'class' => 'form-control', 'placeholder' => 'Masukan kode Aturan', 'readonly']) !!}
                        ...
                        <div class="col-md-12">
                            <div class="form-group first">
                                ...
                                @for ($i = 0; $i < count($gejala); $i++)
                                    ...
                                    <br>
                                @endfor
                                <div class="form-text text-danger">@error('aturan_' . $i){{$message}}@enderror</div>
                            </div>
                        </div>
                    </div>
